...
python3 -c "
b=open('app.html').read(); h,r=b.split('</style>',1)
open('test-page.html','w').write('<!doctype html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">'+h+'</style></head><body>'+r+'</body></html>')"
