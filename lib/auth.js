...
export async function currentUser(req) {
  ...
  /* The token rides along so an operation can tell this sign-in from the
     others - changing your password revokes the rest but not the tab you are
     in. Safe because no endpoint serialises this object; every response picks
     its fields by hand. Keep it that way. */
